...
const getRandomDogPicture = async (): Promise<any> => {
	console.log('Getting a random dog picture from https://dog.ceo/api/breeds/image/random');
	...
	let result;
	try {
		result = await instance.get().then((result) => result.data);
	} catch (error) {
		console.error(error);
	}
